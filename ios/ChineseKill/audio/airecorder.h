...
typedef int (*airecorder_callback)(const void * usrdata, const void * data, int size, const void* dlgdata);
...
int airecorder_start(struct airecorder * recorder, const char* wav_path,
                            ...
                            const void * usrdata, int callback_interval, const void* dlgdata);
 ...
 * get volume
 */
double airecorder_getVolume(struct airecorder * recorder);
